	...
	public static IServiceCollection AddApplication ( this IServiceCollection services )
	{
		...
		services.AddMediatR (
				configuration : configuration =>
				{
					...
					// Now, when we send our command, it's going to first enter the logging behavior, run the logging
		...
		//  This is going to scan the assembly and register any validators as an IValidator instance which we are using
		// in our validation behaviour. 
