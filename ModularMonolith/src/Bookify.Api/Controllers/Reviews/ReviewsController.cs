...
using Bookify.Modules.Bookings.Application.Reviews.AddReview;
using Bookify.Modules.Bookings.Application.Reviews.DeleteReview;
using Bookify.Modules.Bookings.Application.Reviews.GetReview;
using Bookify.Modules.Bookings.Application.Reviews.UpdateReview;
using MediatR;
...
public class ReviewsController : ControllerBase
{
	...
	public async Task<IActionResult> UpdateReview(
		Guid id, UpdateReviewRequest request, CancellationToken cancellationToken)
	{
