...
using Bookify.Modules.Bookings.Application.Apartments.AddApartments;
using Bookify.Modules.Bookings.Application.Apartments.SearchApartments;
using Bookify.Modules.Bookings.Application.Apartments.UpdateApartments;
using MediatR;
...
public class ApartmentsController : ControllerBase
{
	...
	public async Task<IActionResult> UpdateApartment(
		Guid id, UpdateApartmentRequest request, CancellationToken cancellationToken)
	{
